---
name: prow-decommission-release
description: >-
  Decommission an end-of-life RHDH release branch by removing CI config,
  generated Prow jobs, and branch protection from the openshift/release
  repository. Use when a release reaches end-of-life and CI jobs should be
  removed, or when asked to clean up old release branch configurations.
---
# Decommission RHDH Release Branch Jobs

Remove all CI configuration for a given RHDH release branch when it reaches end-of-life.
...
- **Requires a local `openshift/release` checkout.** This skill deletes files and edits YAML in place.
