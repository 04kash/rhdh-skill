...
**Important:** Overlay repo jobs do NOT support parameter overrides via Gangway. If the user selected an overlay job, skip this step and go directly to Step 3. Mention that overlay jobs always run with their default configuration.
